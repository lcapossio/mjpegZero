...
VHDL-1993 port under `rtl/vhdl/`, AXI interfaces, and up to 1080p30 on low end AMD/Xilinx 7-Series FPGAs. Two operating modes: **Full** has runtime (AXI-programmable) quality; **Lite**
fixes quality at synthesis, dropping the runtime-quality logic (~250 LUT + 2 DSP
