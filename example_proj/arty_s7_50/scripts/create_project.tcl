...
#
# ============================================================================
# create_project.tcl — Vivado project-mode script for Arty S7-50 MJPEG demo
#
# Usage (from repo root):
#   vivado -mode batch -source example_proj/arty_s7_50/scripts/create_project.tcl
#
# Outputs:
#   example_proj/arty_s7_50/build/arty_s7_demo.bit  — bitstream
#   example_proj/arty_s7_50/build/reports/           — utilization + timing reports
# ============================================================================
...
set xdc_file [file normalize $ex_dir/constraints/arty_s7_50.xdc]

# ============================================================================
# Create Vivado project
# ============================================================================
create_project -force arty_s7_demo $proj_dir -part $part
...
# Flow_PerfOptimized_high enables retiming + flatten=rebuilt automatically
# ============================================================================
...
if {[get_property PROGRESS [get_runs synth_1]] != "100%"} {
    error "Synthesis failed — see $proj_dir/arty_s7_demo.runs/synth_1/"
}
...
# ============================================================================
# Implementation run settings
# Performance_ExplorePostRoutePhysOpt: place Explore + two phys-opt passes
# ============================================================================
set_property strategy Performance_ExplorePostRoutePhysOpt [get_runs impl_1]

# Pre-hook: downgrade UCIO-1 so write_bitstream proceeds with auto-placed led1
# (K15 is not a valid CSGA324 ball in Vivado 2025.2; led1 gets auto-placed)
set_property STEPS.WRITE_BITSTREAM.TCL.PRE \
    [file normalize $script_dir/pre_write_bitstream.tcl] \
    [get_runs impl_1]
...
# Run through route_design
launch_runs impl_1 -jobs 4
wait_on_run impl_1

if {[get_property PROGRESS [get_runs impl_1]] != "100%"} {
    error "Implementation failed — see $proj_dir/arty_s7_demo.runs/impl_1/"
}
...
# Copy bitstream to build root (impl run names it after the top module)
set bit_src [glob -nocomplain $proj_dir/arty_s7_demo.runs/impl_1/*.bit]
if {[llength $bit_src] > 0} {
    file copy -force [lindex $bit_src 0] $build_dir/arty_s7_demo.bit
    puts "======================================================================"
    puts "DONE — bitstream: $build_dir/arty_s7_demo.bit"
    puts "======================================================================"
} else {
