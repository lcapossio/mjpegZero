...
# mjpegZero — Synopsys Design Constraints for Intel/Altera Quartus
# Target: 150 MHz (6.667 ns period)
# Apply to: synth_timing_wrapper top-level entity

# Primary clock
create_clock -period 6.667 -name clk [get_ports clk]

# I/O delays (synthesis estimation only — false-path them for implementation)
...
# I/O false paths — only internal timing of the core is validated
